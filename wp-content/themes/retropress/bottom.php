...
<div class='footer_txt'><div class='container'>
			<?php
				...
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com/photography/' target='_blank'>Photography themes</a>, thanks to: <a href='http://wpdis.co/free/spapress/' target='_blank'>Free WordPress medicine themes</a>, <a href='http://lizardthemes.com' target='_blank'>LizardThemes.com</a> and <a href='http://fthe.me/fit-fitnessgym-responsive-wordpress-theme/' target='_blank'>WordPress theme</a></div>
		</div></div>
</div>
<?php
