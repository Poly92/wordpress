...
if ( function_exists( 'register_nav_menu' ) ) {
	...
	function show_right_sidebar_widgets() {
		...
		$instance = array(
			...
			'title' => '',
			'banners' => array(
				'<smt:banner colorscheme=\'dark\' layout=\'6\' link=\'http://smthemes.com/?i=supervisor\'></smt:banner>',
				'<smt:banner colorscheme=\'dark\' layout=\'2\' link=\'http://smthemes.com/?i=supervisor\'></smt:banner>',
				'<smt:banner colorscheme=\'light\' layout=\'2\' link=\'http://smthemes.com/?i=supervisor\'></smt:banner><script type=\'text/javascript\' src="http://smthemes.com/api/banner.js"></script> '
			)
		);
	...
	function show_footer_1_widgets() {
		...
		$rightargs['before_widget'] = '<div class="widget widget_calendar"><div class="inner">';
		the_widget('WP_Widget_Calendar', $instance, $rightargs);
	}
	...
	function show_footer_3_widgets() {
		...
		$rightargs['before_widget'] = '<div class="widget widget_social_profiles"><div class="inner">';
		the_widget('SocialProfiles', $instance, $rightargs);
		$rightargs['before_widget'] = '<div class="widget"><div class="inner">';
		unset($instance);
		$instance['title']='SMThemes';
		$instance['text']='Smart free Wordpress themes on SMT Framework';
		the_widget('WP_Widget_Text', $instance, $rightargs);
