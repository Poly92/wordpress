...
<div class='footer_txt'><div class='container clearfix'>
			<?php
                    if ($SMTheme->get( "layout","footertext" )) {
                        ...
                        ?>Copiright &copy; <?php echo date("Y"); ?>  <a href="<?php echo home_url(); ?>"><?php bloginfo("name"); ?></a><?php
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/pressa/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com/category/auto/' target='_blank'>Free auto WordPress themes</a>, thanks to: <a href='http://wpdis.co/free/' target='_blank'>WordPress child theme</a>, <a href='http://lizardthemes.com' target='_blank'>LizardThemes.com</a> and <a href='http://fthe.me/wordpress-themes/themes-types/real-estate/' target='_blank'>Real Estate WordPress theme</a></div>
		</div></div>
