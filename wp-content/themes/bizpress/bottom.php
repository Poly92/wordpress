		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/bizpress/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com/' target='_blank'>WordPress templates free</a>, thanks to: <a href='http://wpdis.co/' target='_blank'>WordPress blog themes</a>, <a href='http://lizardthemes.com' target='_blank'>LizardThemes.com</a> and <a href='http://fthe.me/rockefeller-flexible-multipurpose-wp-theme/' target='_blank'>Free WP themes</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
