    ...
    $settings = array(
		...
		'slider'=>array(
			...
			'content'=>array(
				...
				'innerpage'=>array(
					'type'=>'check','name'=>'innerpage','value'=>'1','ttl'=>'Show slider on inner pages. If checked "Load content dynamicaly" this option is not considered.'
				)
			)
		),
		'layout'=>array(
			...
			'content'=>array(
				...
				'dynamiccontent'=>array(
					'type'=>'check','name'=>'dynamiccontent','value'=>'1','ttl'=>'Load content dynamicaly', 'hint'=>'Turn on if you want to use dynamic content loader. This options allows to load pages without refresh.'
				),
				'dpagination'=>array(
					'type'=>'check','name'=>'dpagination','value'=>'1','ttl'=>'Load posts dynamicaly', 'hint'=>'Turn on if you want to use dynamic posts loader. This option allows to load posts when user scrolls page to bottom. It used instead of standard pagination.'
				),
				'related'=>array(
